    ...
    public partial class ChamCongForm : Form
    {
        ...
        private void LoadAttendanceData()
        {
            using (SqlConnection connection = new SqlConnection(strCon))
            {
                ...
                inner join ChamCong cc on nv.maNhanVien = cc.maNhanVien
                GROUP BY nv.maNhanVien, nv.hoTen, cv.tenChucVu, pb.tenPhongBan, nv.luongCoBan,pb.heSoPhongBan + cv.heSoChucVu";
        ...
        private void ChamCongForm_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void ChamCongForm_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Cham(object sender, KeyEventArgs e)
        {
