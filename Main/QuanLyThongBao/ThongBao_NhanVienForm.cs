...
namespace Main
{
    public partial class ThongBao_NhanVienForm : Form
    {
        public ThongBao_NhanVienForm()
        {
            InitializeComponent();
        }
        ...
        private void ThongBao_NhanVienForm_Load(object sender, EventArgs e)
        {
            string query = "select tb.maThongBao, nv.hoTen,tieuDe, noiDung,ngayDang, fileDinhKem from ThongBao tb inner join NhanVien_ThongBao nv_tb on tb.maThongBao = nv_tb.maThongBao inner join NhanVien nv on nv.maNhanVien = nv_tb.maNhanVien";
